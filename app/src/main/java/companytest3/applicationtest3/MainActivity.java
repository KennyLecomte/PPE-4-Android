...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getContenuChamps()
    {
        String tempVille, tempCodePostal, tempRaison, tempBudget, tempTrancheAge, tempCategorieSociale;
        Boolean tempVip;

        tempVille = editTextVille.getText().toString();
        tempCodePostal = editTextCodePostal.getText().toString();
        tempRaison = editTextRaison.getText().toString();
        tempBudget = spinnerBudgets.getSelectedItem().toString();
        tempTrancheAge = spinnerTranchesAge.getSelectedItem().toString();
        tempCategorieSociale = spinnerCategorieSociale.getSelectedItem().toString();
        tempVip = checkBoxVip.isChecked();
